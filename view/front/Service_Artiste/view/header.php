...
<nav class="navbar-expand-lg navbar-light badge-light fixed-top">
        <div class="login">
            ...
            <a style="color:black;" href="../../login_page/view/login.php"> <i class="fa fa-sign-in" aria-hidden="true"></i> se connecter/s'inscrire</a>
        </div>
        <div class="titre">
            <a href="#"><img class="logo" src="../assets/front/images/logo.png">
                    ...
                    <div class="card mb-3">
                        <div class="input-group">
                            ...
                            <span class="input-group-append">
                                <button class="btn btn-secondary" href="searchService.php" type="submit">Go!</button>
                            </span>
                        </div>
                    </div>
                </div>
