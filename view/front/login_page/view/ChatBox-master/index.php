<?php 
include_once '../../controller/msgC.php';
include_once '../../model/msg.php';
include_once '../../controller/notifC.php';
...
if ( isset($_POST["msg"]) )
 {
    if( !empty($_POST["msg"])  ) {
        ...
        $msgC->ajoutermsg($msg) ;
        $notifC->supprimernotif($id_s,$id_r) ;

        $notif = new notif( $id_s ,$id_r,date('d-m-y h:i:s'), $_POST["msg"]);
        $notifC->ajoutermsg($notif) ;
