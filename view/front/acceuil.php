       ...
       <div class="card mb-3 product-wap rounded-0">
           <div class="card rounded-0">
               ...
               <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                   ...
                   <a style="color:white;" href="" class="h3 text-decoration-none"> substr('.$row['DESCP'].', 0, 36)</a>
                   <a style="display: block;
                   text-align: center;"class="BC text-white mt-2"href="readmore.php?REFERENCE='.$row['REFERENCE'].'"id="REFERENCE" name="REFERENCE"><span></span>
                   <span></span>
                   <span></span>
