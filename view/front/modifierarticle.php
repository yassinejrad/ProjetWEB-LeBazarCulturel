...
<form action="" method="POST"  >
	<div class="container-contact100">
		<div class="wrap-contact100">
          ...
          <br>
					<input   class="controle" type="text" name="titre" id="titre" placeholder="Entrez le titre du blog" maxlength="70" value="<?php echo $article['titre'];?>" required />
          ...
          <br>
					<input class="controle"   type="text" name="nomAuteur" id="nomAuteur" placeholder="Entrez le nom d'auteur" maxlength="50" required value="<?php echo $article['nomAuteur'];?>"> 
					<span class="resultat"></span>
				</div>
          ...
          <br>
					<input class="controle" name="description" id="description" maxlength="500" placeholder="Entrez votre description ici..." required  value="<?php echo $article['description'];?>" />
                    <span class="resultat"></span>
				</div>
          ...
          <br>
					<input class="controle"  type="date_local" name="dateA" id="dateA" required value="<?php echo $article['dateA'];?>" />
					<span class="resultat"></span>
				</div>
            ...
            <div class="wrap-input100 validate-input" data-validate="Name is required">
                    ...
                    <form class="controle" enctype="multipart/form-data" method="post" autocomplete="on" action="upload/">
                        <p>
                        <input  type="file" name="image" id="image" accept="image/png,image/jpeg" value="<?php echo $article['image'];?>" required />
                        </p>
                        <span class="resultat"></span>
                        </form>
				</div>
